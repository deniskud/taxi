...
echo "<script>document.getElementById('zagolovok').innerHTML='Итого $allpo поездок<br>ВСЕГО: ".number_format($svsego, 0, ',', ' ')."<br> 60%=".number_format($s60, 2, ',', ' ')."<br>наличка: ".number_format(($snal)*-1, 0, ',', ' ')."<br>Баланс: <font color=#";
