...
$execstring='';
$execstr2='';
$execstring='node /var/www/html/ttt/js/'.$agregator.'2db.js /var/www/html/ttt/zmey/uploaded_files/'.$newFileName.' '.$startp.' '.$endp;
echo 'exec string: '.$execstring."<br>\n";
//$execstring='node /var/www/html/taxi/js/'.$agregator.'2db.js /var/www/html/taxi/zmey/uploaded_files/'.$newFileName.' '.$startp.' '.$endp;
