...
$execstring='';
$execstr2='';
//$execstring='node /var/www/html/taxi/js/'.$agregator.'week2db.js /var/www/html/taxi/zmey/uploaded_files/'.$newFileName.' '.$startp.' '.$endp;
$execstring='node /var/www/html/ttt/js/'.$agregator.'week2db.js /var/www/html/ttt/zmey/uploaded_files/'.$newFileName.' '.$startp.' '.$endp;
