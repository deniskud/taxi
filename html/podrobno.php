...
echo "<script>document.getElementById('zagolovok').innerHTML='Итого $poezdall поездок<br>ВСЕГО: ".number_format($svsego, 0, ',', ' ')."<br> 60%=".number_format($s60, 0, ',', ' ')."<br>наличка: ".number_format($snal, 0, ',', ' ')."<br>Баланс: <font color=#";
