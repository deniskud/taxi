...
if (!process.argv[2]) {
  console.log("No file! Usge uklonweek2db FILENAME.XLSX"); 
  return(0);
}
...
//        console.log ("["+i+"]"+id1+" "+id2+" "+" i:"+itogo+" 40%:"+prof40.toFixed(2)+" 60%:"+prof60.toFixed(2)+" g:"+gotivka+" b:"+ balans.toFixed(2));
          cntadd++;
          sqlq="INSERT INTO weekuklon (poezdok, pozivnoy, gosnomer, itogo, pro40, pro60, gotivka,balans,start,end) VALUES('"+poezdok+"','" +id1+"', " + "'"+id2+"',"  + itogo + ", " + prof40.toFixed(2) + ", "+ prof60.toFixed(2) + ", "+ gotivka + ", " + balans.toFixed(2)+ ", '" +start+ "', '" +end + "');"
          console.log(sqlq);
